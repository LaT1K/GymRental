...
const Index = ({ prices = [] }) => {
    ...
    const translateBookingType = {
        'training': 'Тренування',
        'game': 'Гра',
        'sublease': 'Суборенда'
    };

    const translatePricingType = {
        'one_time': 'Одноразово',
        'booking': 'Бронювання'
    };
                                ...
                                {prices.map((price) => (
                                    <tr key={price.id}>
                                        <td className="border-b p-3">
                                            {translateBookingType[price.booking_type] || price.booking_type}
                                        </td>
                                        <td className="border-b p-3">
                                            {translatePricingType[price.pricing_type] || price.pricing_type}
                                        </td>
                                        <td className="border-b p-3">
